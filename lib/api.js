 ...
 * inaction framing) — used by the popup and the right-click flow.
 ...
 * exposed) across 2 lenses instead of grading one line in isolation.
...
/** @param {{headline:string, score:number, principle:string, diagnosis:string, fixes:string[]}} entry */
